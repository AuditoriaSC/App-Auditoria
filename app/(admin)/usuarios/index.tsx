...
const styles = StyleSheet.create({
  ...
  cardEditing: { position: 'relative', zIndex: 100, elevation: 20 },
  ...
  editGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 10, marginTop: 12, alignItems: 'flex-end', position: 'relative', zIndex: 100 },
  ...
  cardActions: { flexDirection: 'row', justifyContent: 'flex-end', gap: 8, marginTop: 12, position: 'relative', zIndex: 1 },
