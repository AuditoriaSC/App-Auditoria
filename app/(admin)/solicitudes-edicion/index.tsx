...
export default function EditApprovalsPage() {
  ...
  if (loading) return <View style={styles.center}><ActivityIndicator size="large" color={brandColors.greenDark} /><Text style={styles.loadingText}>Cargando solicitudes...</Text></View>;
...
const styles = StyleSheet.create({
  screen:{flex:1,backgroundColor:brandColors.background},container:{padding:18,paddingBottom:40,gap:12,maxWidth:960,width:'100%',alignSelf:'center'},center:{flex:1,alignItems:'center',justifyContent:'center',padding:30,backgroundColor:brandColors.background},loadingText:{marginTop:8,color:brandColors.textSecondary},header:{backgroundColor:brandColors.white,padding:16,borderRadius:10,borderWidth:1,borderColor:brandColors.border,flexDirection:'row',justifyContent:'space-between',alignItems:'center',gap:12},title:{fontSize:23,fontWeight:'900',color:brandColors.textPrimary},subtitle:{color:brandColors.textSecondary,marginTop:4},message:{padding:12,backgroundColor:brandColors.creamSoft,color:brandColors.coffeeDark,fontWeight:'800'},card:{backgroundColor:brandColors.white,padding:15,borderRadius:10,borderWidth:1,borderColor:brandColors.border,gap:8},cardTitle:{fontWeight:'900',fontSize:16,color:brandColors.textPrimary},meta:{color:brandColors.textSecondary,fontWeight:'700'},impact:{fontWeight:'900',color:brandColors.greenDark},change:{color:brandColors.textPrimary},reason:{color:brandColors.coffeeDark,fontWeight:'800'},input:{borderWidth:1,borderColor:brandColors.border,borderRadius:8,padding:10,backgroundColor:brandColors.white},actions:{flexDirection:'row',gap:10,justifyContent:'flex-end'},approve:{padding:11,borderRadius:8,backgroundColor:brandColors.greenDark},reject:{padding:11,borderRadius:8,backgroundColor:brandColors.danger},actionText:{color:brandColors.white,fontWeight:'900'},warning:{color:brandColors.warning,fontWeight:'800'},secondary:{padding:10,borderRadius:8,borderWidth:1,borderColor:brandColors.border},secondaryText:{color:brandColors.greenDark,fontWeight:'900'}
});
