...
const styles = StyleSheet.create({
  ...
  pickerContainer: { height: 48, borderWidth: 1, borderColor: brandColors.border, borderRadius: 8, backgroundColor: brandColors.white, marginBottom: 15, overflow: 'hidden', justifyContent: 'center' },
